<script type="text/javascript">
  ...
  <input type="text" id="summa" name="summa" value="${req?.summa?:''}" ${req?.modstatus>1?'readonly':''}/>
  ...
  <g:select name="syscompany_id" value="${req?.syscompany_id?:0}" from="${Company.findAllByModstatusAndIs_system(1,1)}" optionValue="name" optionKey="id" noSelection="${[0:'не выбран']}" disabled="${req?.modstatus>1?'true':'false'}"/>
