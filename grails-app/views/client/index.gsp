<html>
  ...
  <body>  
 <g:if test="${redir}">
    <g:form url="[controller:'client',action:'index']" method="post" name="indexForm" id="indexForm">
    ...
    <g:if test="${flash?.error}">
      <div class="error-box">
        ...
        <ul>
          ...
          <g:elseif test="${flash.error==4}"><li>Доступ заблокирован</li></g:elseif>          
        </ul>
      </div>
    </g:if>      
      <g:form url="[controller:'client',action:'login']" method="post">
